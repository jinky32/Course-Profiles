 ...
 * This is linked to from the "All my courses" link on the profile page, liked to profile box.
 * This will be phased out in 2010 at some point as per @see http://developers.facebook.com/blog/post/326
 * @package cpfa
 ...
 * @param array $items Array structure of course/qualifications for user. Key will be status (past, present, future) and value an 
 * @param string $group Can be "quals" or "courses" for qualifications and modules repectively
 * @return 
 */
...
echo $fbplatform->renderTop($fb_profile_id, '', false, true);
